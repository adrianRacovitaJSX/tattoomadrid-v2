    ...
    <section className="relative pt-24 pb-24 md:pt-28 md:pb-28 lg:pt-32 lg:pb-32 overflow-hidden bg-gradient-to-b from-zinc-950 to-zinc-900 min-h-[600px] flex items-center">
      ...
      >
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            Estamos aquí para resolver tus dudas y ayudarte a crear el tatuaje de tus sueños en nuestro estudio de tatuajes en Madrid. 
            Contacta con nuestro equipo o agenda una consulta gratuita.
          </motion.p>
          ...
          >
            ...
            >
              <span className="text-[#be8f52] mr-1 sm:mr-2">⭐</span> Respuesta rápida
            </motion.span>
            <motion.span 
              className="flex items-center px-2 py-1"
              whileHover={{ scale: 1.05, color: "#be8f52" }}
            >
              <span className="text-[#be8f52] mr-1 sm:mr-2">👨‍🎨</span> Artistas especializados
            </motion.span>
            <motion.span 
              className="flex items-center px-2 py-1"
              whileHover={{ scale: 1.05, color: "#be8f52" }}
            >
              <span className="text-[#be8f52] mr-1 sm:mr-2">🛡️</span> Consultas gratuitas
            </motion.span>
            <motion.span 
              className="flex items-center px-2 py-1"
              whileHover={{ scale: 1.05, color: "#be8f52" }}
            >
              <span className="text-[#be8f52] mr-1 sm:mr-2">🏆</span> Atención personalizada
            </motion.span>
          </motion.div>
        </div>
      </motion.div>
