    ...
    <section className="relative pt-24 pb-24 md:pt-28 md:pb-28 lg:pt-32 lg:pb-32 overflow-hidden bg-gradient-to-b from-zinc-950 to-zinc-900 min-h-[600px] flex items-center">
      ...
      >
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            Conoce a los tatuadores profesionales de nuestro estudio de tatuajes en Madrid.
            Talento, experiencia y pasión en cada trazo que realizamos en tu piel.
          </motion.p>
          ...
          >
            ...
            <motion.span 
              ...
              whileHover={{ scale: 1.05, color: "#be8f52" }}
            >
              <Check size={14} className="text-[#be8f52] mr-1 sm:mr-2 sm:h-4 sm:w-4" /> Múltiples estilos
            </motion.span>
            <motion.span 
              className="flex items-center px-2 py-1"
              whileHover={{ scale: 1.05, color: "#be8f52" }}
            >
              <Check size={14} className="text-[#be8f52] mr-1 sm:mr-2 sm:h-4 sm:w-4" /> Formación internacional
            </motion.span>
            <motion.span 
              className="flex items-center px-2 py-1"
              whileHover={{ scale: 1.05, color: "#be8f52" }}
            >
              <Check size={14} className="text-[#be8f52] mr-1 sm:mr-2 sm:h-4 sm:w-4" /> Premios y reconocimientos
            </motion.span>
          </motion.div>
        </div>
      </motion.div>
