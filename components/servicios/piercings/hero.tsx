      ...
      >
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.p 
            ...
            variants={itemVariants}
          >
            Perforaciones corporales realizadas con los más altos estándares de higiene y seguridad. Utilizamos joyería de alta calidad en titanio y oro.
          </motion.p>
          ...
          >
            ...
            >
              <Check size={14} className="text-[#be8f52] mr-1 sm:mr-2 sm:h-4 sm:w-4" /> Profesionales certificados
            </motion.span>
            <motion.span 
              className="flex items-center px-2 py-1"
              whileHover={{ scale: 1.05, color: "#be8f52" }}
            >
              <Check size={14} className="text-[#be8f52] mr-1 sm:mr-2 sm:h-4 sm:w-4" /> Joyería de calidad
            </motion.span>
            <motion.span 
              className="flex items-center px-2 py-1"
              whileHover={{ scale: 1.05, color: "#be8f52" }}
            ...
            <motion.span 
              ...
              whileHover={{ scale: 1.05, color: "#be8f52" }}
            >
              <Check size={14} className="text-[#be8f52] mr-1 sm:mr-2 sm:h-4 sm:w-4" /> +850 clientes satisfechos
            </motion.span>
          </motion.div>
        </div>
      </motion.div>
...
export default PiercingsHeroSection; 