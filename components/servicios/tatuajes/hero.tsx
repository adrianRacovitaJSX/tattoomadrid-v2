      ...
      >
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.p 
            ...
            variants={itemVariants}
          >
            Diseños únicos adaptados a tus ideas y estilo personal. Nuestros artistas en Madrid crean arte permanente con los más altos estándares de calidad.
          </motion.p>
          ...
          >
            ...
            <motion.span 
              ...
              whileHover={{ scale: 1.05, color: "#be8f52" }}
            >
              <Check size={14} className="text-[#be8f52] mr-1 sm:mr-2 sm:h-4 sm:w-4" /> Todos los estilos
            </motion.span>
            <motion.span 
              className="flex items-center px-2 py-1"
              whileHover={{ scale: 1.05, color: "#be8f52" }}
            ...
            <motion.span 
              ...
              whileHover={{ scale: 1.05, color: "#be8f52" }}
            >
              <Check size={14} className="text-[#be8f52] mr-1 sm:mr-2 sm:h-4 sm:w-4" /> +650 clientes satisfechos
            </motion.span>
          </motion.div>
        </div>
      </motion.div>
...
export default TatuajesHeroSection; 