...
const POST = blogPosts.find((p) => p.slug === 'cuidar-tatuaje-recien-hecho')!;
          ...
          <ScrollReveal direction="up" delay={0.1}>
            <article className="bg-white dark:bg-zinc-900 rounded-xl shadow-md border border-transparent overflow-hidden relative">
              ...
              <div className="p-6 md:p-10">
                ...
                <RelatedCta servicesAnchor="tatuajes" servicesLabel="Servicios de tatuaje y aftercare profesional" />
