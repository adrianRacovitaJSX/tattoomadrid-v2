...
export default function AvisoLegalPage() {
  return (
    <div className="container mx-auto px-4 py-16 md:py-24">
      <div className="max-w-4xl mx-auto bg-zinc-900/60 backdrop-blur-sm p-8 md:p-10 rounded-xl border border-zinc-800/70">
        <h1 className="text-3xl md:text-4xl font-bold mb-6 text-[#be8f52]">AVISO LEGAL</h1>
        <h2 className="text-xl md:text-2xl font-semibold mb-6 text-white">LEY DE LOS SERVICIOS DE LA SOCIEDAD DE LA INFORMACIÓN (LSSI)</h2>
        
        <div className="prose prose-lg prose-invert prose-zinc max-w-none">
          <p>
            Saints And Sinners by Gamboa, responsable del sitio web, en adelante RESPONSABLE, pone a disposición de los usuarios el presente documento, con el que pretende dar cumplimiento a las obligaciones dispuestas en la Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Información y de Comercio Electrónico (LSSICE), BOE N.º 166, así como informar a todos los usuarios del sitio web respecto a cuáles son las condiciones de uso.
          </p>
          
          <p>
            Toda persona que acceda a este sitio web asume el papel de usuario, comprometiéndose a la observancia y cumplimiento riguroso de las disposiciones aquí dispuestas, así como a cualquier otra disposición legal que fuera de aplicación.
            Alexander Gamboa Fiestas se reserva el derecho de modificar cualquier tipo de información que pudiera aparecer en el sitio web, sin que exista obligación de preavisar o poner en conocimiento de los usuarios dichas obligaciones, entendiéndose como suficiente la publicación en el sitio web de Alexander Gamboa Fiestas.
          </p>

          <h3 className="text-lg md:text-xl font-semibold mt-8 mb-4 text-[#be8f52]">1. DATOS IDENTIFICATIVOS</h3>
          <p>
            Nombre de dominio: www.tattoomadrid.com/<br />
            Nombre comercial: Saints And Sinners by Gamboa<br />
            Denominación social: Alexander Gamboa Fiestas<br />
            NIF: 60637576P<br />
            Domicilio social: Calle de los hermanos Gómez 5 Local 1, 28017 Madrid (Madrid)<br />
            Teléfono: 603211318<br />
            E-mail: alex_gamboa_fiestas@hotmail.com
          </p>

          <h3 className="text-lg md:text-xl font-semibold mt-8 mb-4 text-[#be8f52]">2. DERECHOS DE PROPIEDAD INTELECTUAL E INDUSTRIAL</h3>
          <p>
          ...
          <p>
            Para realizar cualquier tipo de observación respecto a posibles incumplimientos de los derechos de propiedad intelectual o industrial, así como sobre cualquiera de los contenidos del sitio web, puede hacerlo a través del correo electrónico alex_gamboa_fiestas@hotmail.com.
          </p>

          <h3 className="text-lg md:text-xl font-semibold mt-8 mb-4 text-[#be8f52]">3. EXENCIÓN DE RESPONSABILIDADES</h3>
          <p>
          ...
          <h4 className="text-base font-semibold mt-6 mb-3 text-white">Uso de Cookies</h4>
          <p>
          ...
          <h4 className="text-base font-semibold mt-6 mb-3 text-white">Política de enlaces</h4>
          <p>
          ...
          <h4 className="text-base font-semibold mt-6 mb-3 text-white">Direcciones IP</h4>
          <p>
          ...
          <h3 className="text-lg md:text-xl font-semibold mt-8 mb-4 text-[#be8f52]">4. LEY APLICABLE Y JURISDICCIÓN</h3>
          <p>
