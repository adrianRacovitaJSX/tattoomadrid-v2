  ...
  return (
    <div className="container mx-auto px-4 py-16 md:py-24">
      <div className="max-w-4xl mx-auto bg-white text-black p-8 md:p-10 rounded-xl border border-zinc-200 shadow-md">
        <h1 className="text-3xl md:text-4xl font-bold mb-6 text-center">WEB: Aviso legal</h1>
        
        <div className="prose prose-lg max-w-none text-black">
          <p className="text-center mb-8">
            <strong>LEY DE LOS SERVICIOS DE LA SOCIEDAD DE LA INFORMACIÓN (LSSI)</strong>
          </p>

          <p className="text-justify">
            Alexander Gamboa Fiestas, responsable del sitio web, en adelante RESPONSABLE, pone a disposición de los usuarios el presente documento, con el que pretende dar cumplimiento a las obligaciones dispuestas en la Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Información y de Comercio Electrónico (LSSICE), BOE N.º 166, así como informar a todos los usuarios del sitio web respecto a cuáles son las condiciones de uso.
          </p>
          ...
          <h3 className="text-lg md:text-xl font-semibold mt-8 mb-4">1. DATOS IDENTIFICATIVOS</h3>
          <p>
            Nombre de dominio: tattoomadrid.com<br />
            Nombre comercial: Saints And Sinners by Gamboa<br />
            Denominación social: Alexander Gamboa Fiestas<br />
            NIF: 60637576P<br />
            Domicilio social: Calle de los hermanos Gómez 5 Local 1, 28017 Madrid<br />
            Teléfono: 603211318<br />
            E-mail: snstattoomadrid@gmail.com
          </p>

          <h3 className="text-lg md:text-xl font-semibold mt-8 mb-4">2. DERECHOS DE PROPIEDAD INTELECTUAL E INDUSTRIAL</h3>
          <p className="text-justify">
          ...
          <p className="text-justify">
            Para realizar cualquier tipo de observación respecto a posibles incumplimientos de los derechos de propiedad intelectual o industrial, así como sobre cualquiera de los contenidos del sitio web, puede hacerlo a través del correo electrónico snstattoomadrid@gmail.com.
          </p>

          <h3 className="text-lg md:text-xl font-semibold mt-8 mb-4">3. EXENCIÓN DE RESPONSABILIDADES</h3>
          <p className="text-justify">
          ...
          <h4 className="text-base font-semibold mt-6 mb-3">Uso de Cookies</h4>
          <p className="text-justify">
          ...
          <h4 className="text-base font-semibold mt-6 mb-3">Política de enlaces</h4>
          <p className="text-justify">
          ...
          <h4 className="text-base font-semibold mt-6 mb-3">Direcciones IP</h4>
          <p className="text-justify">
          ...
          <h3 className="text-lg md:text-xl font-semibold mt-8 mb-4">4. LEY APLICABLE Y JURISDICCIÓN</h3>
          <p className="text-justify">
