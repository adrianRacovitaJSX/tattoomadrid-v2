  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-6">
            ...
            <div>
              ...
              <div className="mt-2 flex flex-wrap items-center gap-3 text-sm text-zinc-400">
                <span className="inline-flex items-center gap-1.5">
                  ...
                  <span className="font-mono">{formatPhone(lead.telefono)}</span>
                </span>
                {lead.email && (
                  <span className="inline-flex items-center gap-1.5">
        ...
        <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-3 border-t border-zinc-800 pt-6">
          <InfoField label="Entrada" value={formatRelative(lead.fecha_entrada)} />
          <InfoField
      ...
      <div>
        <div className="mb-4 flex items-center gap-2">
          ...
          <h3 className="text-sm font-medium uppercase tracking-wider text-zinc-500">
            Conversación ({chat.length} mensajes)
          </h3>
        </div>
        <div className="rounded-xl border border-zinc-800 bg-zinc-900/30 p-4 md:p-6">
          <ChatView messages={chat} />
        </div>
      </div>
    </div>
  );
